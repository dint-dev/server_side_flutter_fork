...
abstract class SemanticsUpdateBuilder {
  ...
  factory SemanticsUpdateBuilder() = _SemanticsUpdateBuilder;
...
///  * [LocaleStringAttribute], which causes the assistive technologies to
///    treat the string in the specific language.
abstract base class StringAttribute {
...
final class _SemanticsUpdate implements SemanticsUpdate {
  @override
  void dispose() {
  }
}

final class _SemanticsUpdateBuilder implements SemanticsUpdateBuilder {
  @override
  SemanticsUpdate build() {
    return _SemanticsUpdate();
  }
