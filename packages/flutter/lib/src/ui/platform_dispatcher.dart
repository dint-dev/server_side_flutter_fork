...
typedef SemanticsActionEventCallback =
    void Function(SemanticsActionEvent action);
...
class RootIsolateToken {
  ...
  static final RootIsolateToken? instance = () {
   ...
   static int __getRootIsolateToken() => 1;
}
...
class PlatformDispatcher {
  /// Private constructor, since only package:flutter/ui.dart is supposed to create one of
  ...
  /// object statically.
  static PlatformDispatcher get instance => ServerSideFlutterState.instance.platformDispatcher;
  ...
  late final Map<int, FlutterView> _views = <int, FlutterView>{
    _implicitViewId: FlutterView._(
      _implicitViewId,
      this,
      ViewConfiguration(),
    ),
  ...
  FlutterView? get implicitView {
    ...
    // Make sure [implicitView] never changes.
    assert(() {
  ...
  void addView(int id, ViewConfiguration viewConfiguration) {
  ...
  void sendViewFocusEvent(ViewFocusEvent event) {
  ...
  void updateDisplays(List<Display> displays) {
    _displays.clear();
...
static void _requestViewFocusChange(
    int viewId,
    int state,
    int direction,
  ) {}
  ...
  // Called from the engine, via hooks.dart
  void beginFrame(int microseconds) {
    _invoke1<Duration>(
      onBeginFrame,
      _onBeginFrameZone,
  ...
  // Called from the engine, via hooks.dart
  void dispatchPointerDataPacket(ByteData packet) {
    ...
    for (var i = 0; i < length; ++i) {
      ...
      data.add(
        PointerData(
          ...
          timeStamp: Duration(
            microseconds: packet.getInt64(kStride * offset++, _kFakeHostEndian),
          ),
          ...
          pointerIdentifier: packet.getInt64(
            kStride * offset++,
            _kFakeHostEndian,
          ),
          physicalX: packet.getFloat64(kStride * offset++, _kFakeHostEndian),
          physicalY: packet.getFloat64(kStride * offset++, _kFakeHostEndian),
          physicalDeltaX: packet.getFloat64(
            kStride * offset++,
            _kFakeHostEndian,
          ),
          physicalDeltaY: packet.getFloat64(
            kStride * offset++,
            _kFakeHostEndian,
          ),
  ...
  set onKeyData(KeyDataCallback? callback) {
    ...
    if (callback != null) {
      channelBuffers.setListener(
        _kFlutterKeyDataChannel,
        _keyDataListener(callback, Zone.current),
      );
    } else {
  ...
  static KeyData _unpackKeyData(ByteData packet) {
    ...
    var offset = 0;
    final int charDataSize = packet.getUint64(
      kStride * offset++,
      _kFakeHostEndian,
    );
    final String? character = charDataSize == 0
        ...
        : utf8.decoder.convert(
            packet.buffer.asUint8List(
              kStride * (offset + _kKeyDataFieldCount),
              charDataSize,
            ),
          );
  ...
  static void __registerBackgroundIsolate(int rootIsolateId) {}
  ...
  void setSemanticsTreeEnabled(bool enabled) =>
      _setSemanticsTreeEnabled(enabled);

  static void _setSemanticsTreeEnabled(bool update) {}
  ...
  /// Called by [dispatchPlatformMessage].
  ...
  // Called from the engine, via hooks.dart
  void updateAccessibilityFeatures(int values) {
  ...
  void setApplicationLocale(Locale locale) =>
      _setApplicationLocale(locale.toLanguageTag());

  static void _setApplicationLocale(String locale) {}
  ...
  Locale? computePlatformResolvedLocale(List<Locale> supportedLocales) {
    ...
    final List<String> result = _computePlatformResolvedLocale(
  ...
  // Called from the engine, via hooks.dart
  void updateLocales(List<String> locales) {
  ...
  // Called from the engine, via hooks.dart
  String localeClosure() => locale.toString();
  ...
  // Called from the engine, via hooks.dart
  void updateInitialLifecycleState(String state) {
  ...
  double? get lineHeightScaleFactorOverride =>
      _configuration.lineHeightScaleFactorOverride;
  ...
  double? get paragraphSpacingOverride =>
      _configuration.paragraphSpacingOverride;
  ...
  // Called from the engine, via hooks.dart
  void updateUserSettingsData(String jsonData) {
    ...
    final nativeSpellCheckServiceDefined =
    ...
    final Brightness platformBrightness = switch (data['platformBrightness']) {
      ...
      final Object? value => throw StateError(
        '$value is not a valid platformBrightness.',
      ),
    };
  ...
  // Called from the engine via hooks.dart.
  void updateFrameData(int frameNumber) {
  ...
  bool dispatchError(Object error, StackTrace stackTrace) {
    if (_onError == null) {
      return false;
    }
    ...
    if (identical(_onErrorZone, Zone.current)) {
      ...
      try {
        return _onErrorZone!.runBinary<bool, Object, StackTrace>(
          _onError!,
          error,
          stackTrace,
        );
  ...
  double? _scaleAndMemoize(int unscaledFontSize) {
    ...
    switch (fontSize) {
      ...
      case final double errorCode:
        assert(
          false,
          'Unknown error: GetScaledFontSize failed with $errorCode.',
        );
    }
    return null;
  }
...
///
/// Immutable class (but can't use @immutable in package:flutter/ui.dart)
class _PlatformConfiguration {
  ...
  /// package:flutter/ui.dart. See the [_getScaledFontSize] function for an example.
  ///
  ...
  /// does not use nonlinear text scaling, or when package:flutter/ui.dart has not received any
...
class ViewPadding {
  ...
  static const ViewPadding zero = ViewPadding._(
    left: 0.0,
    top: 0.0,
    right: 0.0,
    bottom: 0.0,
...
class SemanticsActionEvent {
  ...
  SemanticsActionEvent copyWith({
    ...
    return SemanticsActionEvent(
      ...
      arguments: arguments == _noArgumentPlaceholder
          ? this.arguments
          : arguments,
    );
  }
